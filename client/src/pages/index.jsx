...
import { Shield, Plus, Activity, Users } from "lucide-react";
      ...
      <main className="flex-1 flex items-center justify-center px-6 py-16">
        <div className="max-w-4xl w-full text-center animate-fade-in">
          ...
          <p className="text-lg sm:text-xl text-slate-500 max-w-2xl mx-auto mb-10 leading-relaxed">
            A centralized platform for college students to report campus issues — from
            broken AC to Wi-Fi outages — and watch them get resolved in real time.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
            <Link
              to="/register"
              className="btn-primary text-base px-8 py-3 rounded-xl shadow-lg shadow-brand-500/25"
            >
              Submit a Complaint
              <svg
                className="w-4 h-4"
          ...
          <div className="grid sm:grid-cols-3 gap-6 text-left">
            {[
              ...
              <div
                key={i}
                className="card p-6 group hover:shadow-card-hover transition-all duration-200"
              >
